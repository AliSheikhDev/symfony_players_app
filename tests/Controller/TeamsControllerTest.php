...
class TeamsControllerTest extends WebTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = static::getContainer()->get('doctrine')->getRepository(Teams::class);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setMoney_balance('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'team[money_balance]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getMoney_balance());
    }
